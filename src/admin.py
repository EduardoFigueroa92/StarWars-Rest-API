...
def setup_admin(app):
    ...
    admin.add_view(ModelView(FavoritosPlaneta, db.session))
    admin.add_view(ModelView(FavoritosPersonaje, db.session))
    admin.add_view(ModelView(FavoritosVehiculo, db.session))
